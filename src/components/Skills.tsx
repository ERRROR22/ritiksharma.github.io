...
const skillCategories = [
  {
    ...
    icon: Code,
    color: "primary",
    skills: ["Python", "C++", "C", "Java", "JavaScript", "TypeScript", "PHP", "SQL", "Bash", "HTML/CSS"],
  },
  {
  ...
  },
  {
    ...
    icon: Database,
    color: "primary",
    skills: ["MySQL", "PostgreSQL", "MongoDB", "Redis", "Supabase", "Firebase", "Vector DBs (Pinecone, FAISS)"],
  },
  {
    title: "Cybersecurity",
    icon: Shield,
  ...
  },
  {
    ...
    icon: Cloud,
    color: "project",
    skills: ["AWS", "GCP", "Azure", "Docker", "Kubernetes", "CI/CD (GitHub Actions)", "Git", "Linux", "Nginx"],
  },
  {
